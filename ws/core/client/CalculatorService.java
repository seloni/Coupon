 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.core/", wsdlLocation = "http://localhost:8080/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.core/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.core/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.core/", "CalculatorPort"), Calculator.class, features);
    }
